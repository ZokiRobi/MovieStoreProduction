...
namespace Movies.API.Controllers
{
    ...
    public class MovieController : Controller
    {
        ...
        public async Task<IActionResult> GetMovie(int id)
        {
            ...
            movieForReturn.Photos = movieForReturn.Photos.OrderByDescending(x => x.isMain);
            ...
            if (file.Length > 0)
            {
                using (var stream = file.OpenReadStream())
                {
                    var uploadParams = new ImageUploadParams()
                    {
                        ...
                        Transformation = new Transformation().Width(300).Height(400)
                    };
        ...
        {
            var movies = _context.Movies.Where(m => m.InCart);
        ...
        {
            var movie = _context.Movies.Find(movieId);
            var user = _context.Useri.Find(userId);
